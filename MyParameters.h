...
//===============================FILTER============================================
        ...
        //Resonance - a value between 0 and 1; higher values increase the resonance and can result in self oscillation!
        ...
        //Drive - saturation amount; it can be any number greater than or equal to one. Higher values result in more distortion.
